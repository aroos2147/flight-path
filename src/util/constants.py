...
SPARK = (SparkSession.builder
            .appName("FlightPath")
            .config("spark.jars.packages", "org.neo4j:neo4j-connector-apache-spark_2.13:5.3.10_for_spark_3,io.graphframes:graphframes-spark3_2.13:0.10.0")
            .config("spark.checkpoint.dir", "spark/checkpoint")
            .getOrCreate())
